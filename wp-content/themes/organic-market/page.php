...
<?php do_action( 'organic_market_page_header' ); ?>

<main role="main" id="maincontent" class="middle-align">
    <div class="container">
        <?php
        $organic_market_left_right = get_theme_mod( 'organic_market_single_page_sidebar_layout','One Column');
        if($organic_market_left_right == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 left-sidebar-page background-img-skin">
                    <?php if (get_theme_mod('organic_market_single_page_breadcrumb',true) != ''){ ?>
...
<?php do_action( 'organic_market_page_footer' ); ?>
