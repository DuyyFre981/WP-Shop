		...
		<div class="row">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 align-self-center">
				...
				<?php if ( get_theme_mod('grocery_shopping_header_email') ) : ?>
					<span class="mr-3"><i class="fas fa-paper-plane mr-2"></i><?php echo esc_html( get_theme_mod('grocery_shopping_header_email' ) ); ?></span>
				<?php endif; ?>
				<?php if ( get_theme_mod('grocery_shopping_header_phone_number') ) : ?>
					<span class="mr-3"><i class="fas fa-phone mr-2"></i><?php echo esc_html( get_theme_mod('grocery_shopping_header_phone_number' ) ); ?></span>
				<?php endif; ?>
			</div>
